...
const fieldSpecs = [
  ...
  ["generation-form", [
    ...
    ["structure.force_constants.displacement", "FC displacement", "text"],
    ["structure.force_constants.first_atom", "FC first atom", "number"],
    ["structure.force_constants.last_atom", "FC last atom", "number"],
    ["structure.force_constants.lua_script", "Lua script", "text"],
    ["structure.force_constants.save_tshs", "Save TSHS", "checkbox"],
    ["structure.force_constants.save_tsde", "Save TSDE", "checkbox"],
    ["structure.force_constants.save_dhs", "Save dHS", "checkbox"],
    ["structure.force_constants.dHdR_tolerance", "dHdR tolerance", "text"],
    ["structure.force_constants.dSdR_tolerance", "dSdR tolerance", "text"],
  ...
  ["siesta-form", [
    ...
    ["structure.siesta.Save.HS", "Save HS", "text"],

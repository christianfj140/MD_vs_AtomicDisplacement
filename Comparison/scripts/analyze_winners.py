...
METADATA_COLUMNS = {
    ...
    "frozen_test_warning",
    "split_provenance_warning",
    "test_set_provenance_warning",
    "frozen_test_provenance_warning",
    "compatibility_hash_warning",
    "frozen_test_hash",
...
def severe_warning_values(rows: list[dict[str, Any]]) -> list[str]:
    warning_columns = [
        ...
        "prediction_warning",
        "evaluation_warning",
        "metrics_provenance_warning",
        "target_semantics_warning",
        "overlap_safety_warning",
        "severe_warnings",
    ]
    return sorted(
        {
    ...
    severe_warnings = sorted(
        {
            ...
            for value in (
                ...
                row.get("method_provenance_warnings"),
                row.get("method_provenance_severe_warnings"),
                row.get("budget_mismatch_warning"),
                row.get("leakage_warning"),
                row.get("frozen_test_warning"),
                row.get("split_provenance_warning"),
                row.get("test_set_provenance_warning"),
                row.get("frozen_test_provenance_warning"),
                row.get("compatibility_hash_warning"),

...
def render_train_config(
    ...
    *,
    ...
    section_map = {
        ...
        "training_weighting_policy": ("hyperparameter", "training_weighting_policy"),
        "domain_threshold_atoms": ("hyperparameter", "domain_threshold_atoms"),
        "small_domain_weight": ("hyperparameter", "small_domain_weight"),
        "large_domain_weight": ("hyperparameter", "large_domain_weight"),

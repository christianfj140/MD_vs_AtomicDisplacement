...
- autocorrelation_unavailable_insufficient_group_samples
...
- `.test_tmp/paper_audit_check_v2/dataset_size_minimum_results.csv`
- `.test_tmp/paper_audit_check_v2/dataset_size_minimum_summary.json`
- `.test_tmp/paper_audit_check_v2/dataset_size_minimum_report.md`
